...
* Graphe. Créer une carte heuristique des objets et leurs liens.
...
Vous pouvez faire un clic-droit sur une cellule contenant une c

Vous pouvez effectuer un clic droit sur une cellule contenant du texte codé par cooccurrence pour créer un nouveau code fusionné combinant les deux codes qui se chevauchent.

Exemples de graphe de cooccurrence et de graphe de clusters.
...
## Graphe (carte heuristique)

[Voir la page dédiée](5.5.-Graph)

## Analyse assisté par l’IA

[Voir la page dédiée](5.1.-AI-chat-based-analysis)