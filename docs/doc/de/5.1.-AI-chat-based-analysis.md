...
- Er basiert auf derselben Suchtechnologie wie das [KI-gestützte Coding](../en/4.2.-AI-Assisted-Coding).
...
2) Auswahl eines **analytischen Prompts**:
   ...
   (Als Option für Fortgeschrittene können eigene analytische Prompts definiert werden, indem die Schaltfläche „Bearbeiten“ geklickt wird, welche die [KI-Prompt-Bibliothek](../en/6.2.-AI-Prompt-Library) öffnet.)
...
Eigene Arten der Textanalyse können durch Hinzufügen zur [KI-Prompt-Bibliothek](../en/6.2.-AI-Prompt-Library) definiert werden (Option für Fortgeschrittene).
